...
<body class="hold-transition skin-red sidebar-mini">
 ...
 <?php if ($_SESSION['perfil'] == "Super Administrador") { ?>     
        ...
        <div class="row">
         ...
         <iframe width="1000" height="600" src="https://app.powerbi.com/view?r=eyJrIjoiYzc4ZTFhNWMtODdhNy00YzJiLWE5ZWEtN2VmZWNmMTg1Y2NhIiwidCI6IjM5OTQ0MjI5LWIzZjEtNGQ1My04MmEyLTExODFjODljMTg4NyIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe>
          </div>
