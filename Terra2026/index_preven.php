    ...
    <div class="content-wrapper">
      ...
      <section class="content">
       <div class="row">
        ...
        <?php if ($_SESSION['perfil'] == "Super Administrador" or $_SESSION['perfil'] == "Prevencion de Riesgo" or $_SESSION['perfil'] == "Coordinador de Calidad" ) { ?>
        <!-- Usuarios -->
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h4><br>Prevención<br>Riesgo</h4>
            </div>
            <div class="icon">
              <i class="fa fa-table"></i>
            </div>
            <a href="lista_estadisticas.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-blue">
            <div class="inner">
              <h4>Dashboard de Estadisticas<br>de Prevención <br><br> <strong></strong></h4>
            </div>
            <div class="icon">
              <i class="fa fa-table"></i>
            </div>
            <a href="grafico_prevencion.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
