...
<html>
<head>
  <title>Constructora Terra - Graficos Observaciones</title>
  <?php echo head(); ?>
</head>
    ...
    <!-- Left side column. contains the logo and sidebar -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
              <i class="fa fa-exclamation-circle"></i> Informe de Observaciones por M2
              <small>Página para Graficos de Observaciones. <i class="fa fa-info"></i></small>
            </h1>

            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Sistema de Gestión de Datos</a></li>
              <li class="active">Observaciones Por M2</li>
            </ol>
        </section>
        
 <?php if ($_SESSION['perfil'] == "Super Administrador" or $_SESSION['perfil'] == "Administrador" or $_SESSION['perfil'] == "Coordinador de Calidad" or $_SESSION['perfil'] == "Encargado de Calidad") { ?>     
        <!-- CONTENIDO PRINCIPAL -->
        ...
        <div class="row">
         ...
         <iframe title="Terra_Observaciones" width="1140" height="542" src="https://app.powerbi.com/view?r=eyJrIjoiOTg0MTBlNjEtYWNkYi00ZDUzLTliNjctZjg0NzgxNjQxOTlhIiwidCI6IjIxNDZlNDI2LWY5ZjEtNDUwYi05OTk2LWNiOTcxZTU3MzZhNSIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe>
