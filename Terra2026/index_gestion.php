    ...
    <div class="content-wrapper">
      ...
      <section class="content">
       <div class="row">
        ...
        <?php if ($_SESSION['perfil'] == "Super Administrador" or $_SESSION['perfil'] == "Coordinador de Calidad" or $_SESSION['perfil'] == "Encargado de Calidad" ) { ?>
        <!-- Usuarios -->
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h4>Salidas<br>No Conformes<br> <strong>R-SG-03</strong></h4>
            </div>
            <div class="icon">
              <i class="fa fa-table"></i>
            </div>
            <a href="index_salidas_no_c.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-blue">
            <div class="inner">
              <h4>Control de <br>No Conformidades <br><br> <strong></strong></h4>
            </div>
            <div class="icon">
              <i class="fa fa-table"></i>
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-red">
            <div class="inner">
              <h4>Auditorias<br> <br><br><strong></strong></h4>
            </div>
            <div class="icon">
          ...
          <div class="small-box bg-purple">
            <div class="inner">
              <h4>Control de la<br>Información Doc. <br><strong>R-SG-01</strong></h4>
            </div>
            <div class="icon">
              <i class="fa fa-file"></i>
            </div>
            <a href="lista_matriz_doc.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
