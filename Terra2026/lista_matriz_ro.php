...
<head>
  <?php echo head(); ?>
  <title>TERRA Constructora - Gestión de Salida No Confomre</title>
</head>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          <i class="fa fa-user"></i> Matriz de Riesgo y Oport.
          <small>Página para la gestión de Matriz de Rie. y Oport. <i class="fa fa-info"></i></small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-info"></i></a></li>
          <li class="active">Matriz de Riesgos y Oportunidades.</li>
        </ol>
      </section>
          ...
          <div class="col-md-12">
            <div class="box box-primary">
               <div class="box-header with-border col-md-12">
                  <a href="reg_matrizro.php"><button type="button" class="btn btn-primary pull-left"><i class="fa fa-plus"></i> Agregar Nueva Matriz</button></a>
                  <a href="clases/reporte.php"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-file-excel-o" ></i>  Descargar Matrices</button></a>
               </div><!-- /.box-header -->
