       ...
       <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h4>Gestion de Percepcion del<br> Cliente <br> <strong>R-SG-15</strong></h4>
            </div>
            <div class="icon">
              <i class="fa fa-file-text"></i>
            </div>
            <a href="lista_enc_per.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
         <?php } ?>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-red">
            <div class="inner">
              <h4>Dashboard <br>Percepcion del<br> Cliente <br></h4>
            </div>
            <div class="icon">
              <i class="fa fa-window-maximize"></i>
            </div>
            <a href="grafico_encuesta.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
         <?php } ?>
