...
echo "<br>17) Clasificacion ".$clasificacion."";
echo "<br>19) funcion_1 ".$funcion_1."";
echo "<br>20) caso = ".$caso." ";
...
$con = new matrizro();
$con->editarmatriz($proceso, $contexto, $part_int, $rie_opo, $suceso, $consecuencia, $probabilidad,$magnitud, $clasificacion, $severidad, $optradio, $descripcion_2, $frecuencia, $funcion_1, $plazo, $eficacia, $evidencia1, $fecha, $estado, $caso);
