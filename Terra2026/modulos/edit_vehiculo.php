...
$con = new Vehiculos();
$con->editarVehiculo($matricula, $serial_carroc, $serial_motor, $marca, $modelo, $anno, $color, $num_puertas, $annos_servicio, $tipo_motor, $combustible_opc, $tanque_gas, $ejes, $peso, $num_cilindros, $activo, $transp_asig);
