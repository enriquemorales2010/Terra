...
$con = new matrizdoc();
$con->editararmatrizdoc($id_doc, $codigo_php, $origen_doc, $tipo, $mproceso, $num_doc, $nombre, $n_version, $estado_ver, $fecha_elab, $ubicacion, $observacion, $responsable, $responsable1, $responsable2, $responsable3, $responsable4, $almacenamiento, $proteccion, $recuperacion, $retencion, $disposicion);
