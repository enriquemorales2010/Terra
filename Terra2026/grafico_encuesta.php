    ...
    <!-- Left side column. contains the logo and sidebar -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
              <i class="fa fa-exclamation-circle"></i> Encuesta de Percepción
              <small>Página para Graficos de Enc. de Perc. <i class="fa fa-info"></i></small>
            </h1>

            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Sistema de Gestión de Datos</a></li>
              <li class="active">Percepción de Cliente</li>
            </ol>
        </section>
 ...
 <?php if ($_SESSION['perfil'] == "Super Administrador" or $_SESSION['perfil'] == "Administrador" or $_SESSION['perfil'] == "Encargado de Calidad" or $_SESSION['perfil'] == "Coordinador de Calidad") { ?>     
        ...
        <div class="row">
         ...
         <div class="col-xs-12" style="text-align:  center;" >
            ...
            <iframe title="Terra_Encuesta" width="1140" height="542" src="https://app.powerbi.com/view?r=eyJrIjoiODRmNDQ2ZjUtMDA0NS00ZjcyLTk5MmMtNjgxZDk2NTUwZDIyIiwidCI6IjIxNDZlNDI2LWY5ZjEtNDUwYi05OTk2LWNiOTcxZTU3MzZhNSIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe>
