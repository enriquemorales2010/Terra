       ...
       <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h4>Percepcion del<br> Cliente <br> <strong>R-SG-15</strong></h4>
            </div>
            <div class="icon">
              <i class="fa fa-file-text"></i>
            </div>
            <a href="index_per_clie.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
         <?php } ?>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-purple">
            <div class="inner">
              <h4>Observaciones<br>Por M2 <br> <strong>R-EO-50</strong></h4>
            </div>
            <div class="icon">
              <i class="fa fa-file-text"></i>
            </div>
            <a href="index_ob_m2.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
         <?php } ?>
