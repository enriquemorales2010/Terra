...
<body class="hold-transition skin-red sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
              ...
              <small>Página para Graficos de los Post-Ventas. <i class="fa fa-info"></i></small>
            </h1>
 ...
 <?php if ($_SESSION['perfil'] == "Super Administrador" || $_SESSION['perfil'] == "Ejecutivo Post-Ventas" or $_SESSION['perfil'] == "Usuario Basico"  or $_SESSION['perfil'] == "Administrador" or $_SESSION['perfil'] == "Encargado de Calidad" or $_SESSION['perfil'] == "Coordinador de Calidad") { ?>     
        <!-- CONTENIDO PRINCIPAL -->
        ...
        <iframe title="Terra_Costos" width="1140" height="542" src="https://app.powerbi.com/view?r=eyJrIjoiNzNjYTdkNTMtMzdhZi00OTNlLTliZjctMmMzZjNkMmZiODNkIiwidCI6IjIxNDZlNDI2LWY5ZjEtNDUwYi05OTk2LWNiOTcxZTU3MzZhNSIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe>
