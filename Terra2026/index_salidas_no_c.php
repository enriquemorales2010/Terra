       ...
       <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h4>Control de Salidas<br>No Conformes<br> <strong>R-SG-03</strong></h4>
            </div>
            <div class="icon">
              <i class="fa fa-table"></i>
            </div>
            <a href="lista_salidanc.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-blue">
            <div class="inner">
              <h4>Dashboard de Salidas<br>No Conformes<br><br> <strong></strong></h4>
            </div>
            <div class="icon">
              <i class="fa fa-table"></i>
            </div>
            <a href="grafico_salidas_n.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
