       ...
       <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h4>Evalución de Riesgo y<br> oportunidades <strong>R-SG-02</strong> </h4>
            </div>
            <div class="icon">
              <i class="fa fa-exclamation-triangle"></i>
            </div>
            <a href="lista_matriz_ro.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
