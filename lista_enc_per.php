...
<head>
  <?php echo head(); ?>
  <title>TERRA - Gestión de Ejecucion de Obras</title>
</head>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          <i class="fa fa-user"></i> Encuesta de Perc.del Cliente
          <small>Página para la gestión de Encuenta <i class="fa fa-info"></i></small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-info"></i></a></li>
          <li class="active">Enc. de Percepcion del Cliente</li>
        </ol>
      </section>
          ...
          <div class="col-md-12">
            <div class="box box-primary">
               <div class="box-header with-border col-md-12">
                 <a href="reg_enc_perc.php"> <button type="button" class="btn btn-primary pull-left" ><i class="fa fa-plus"></i> Agregar Nuevo Encuesta</button></a>
