...
$idcaso = $_POST['caso1'];
$idfallasv = $_POST['fallav'];
$idfallacaso = $_POST['caso_falla'];
$idfallas = $_POST['id_fallas'];
//$idfalla = $_POST['clase_falla'];
...
echo "Numero del Caso ".$idcaso."<br>";
echo "Numero de falla Nuevo ".$idfallas."<br>";
echo "Numero de falla Verificador".$idfallasv."<br>";
echo "Numero de falla en el Caso ".$idfallacaso."<br>";
...
$con = new fallas();
$con->editarfallacaso($idcaso, $idfallas, $idfallacaso);
