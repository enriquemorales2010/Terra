...
$con = new enc_perc();
$con->registrarencperc($proyecto, $fecha_proyecto, $SelectorItem, $ditem1, $item1, $ditem2, $item2, $ditem3, $item3, $ditem4, $item4, $ditem5, $item5, $ditem6, $item6, $ditem7, $item7, $obs_adi, $nom_enc, $fecha_enc,$promedio);
