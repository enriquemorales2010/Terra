    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          ...
          <small>Página de Proceso de Operaciones. <i class="fa fa-info"></i></small>
        </h1>
       ...
       <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h4>Ejecución de<br> Obras</h4>
            </div>
            <div class="icon">
              <i class="fa fa-signal"></i>
            </div>
            <a href="index_ej.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
         <?php } ?>


         <?php if ($_SESSION['perfil'] == "Super Administrador" or $_SESSION['perfil'] == "Coordinador de Calidad" or $_SESSION['perfil'] == "Encargado de Calidad" or $_SESSION['perfil'] == "Administrador"
         or $_SESSION['perfil'] == "Prevencion de Riesgo") { ?>  
        <div class="col-md-3 col-sm-6 col-xs-6 ">
          <div class="small-box bg-blue">
            <div class="inner">
              <h4>Estadisticas de <br> Prevención <br><br></h4>
            </div>
            <div class="icon">
              <i class="fa fa-exclamation"></i>
            </div>
            <a href="index_preven.php" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <?php } ?>
